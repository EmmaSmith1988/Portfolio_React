  ...
  return (
    <div id="about" className='about'>
      ...
      <div className="about__buttons">
       <a className="about__link1" href="https://github.com/EmmaSmith1988" target="_blank" rel="noreferrer"><img className="about__github" src={github_logo} alt="github logo"/></a>
       <a className="about__link2" href="#home" target="_blank"><img className="about__email" src={email_logo} alt="email envelope"/></a>
       <a className="about__link3" href="https://www.linkedin.com/in/emma-smith-a8b4771a9/" target="_blank" rel='noreferrer'><img className="about__linkedin" src={linkedin_logo} alt="linkedin logo"/></a>
       <a className="about__link4" href={EmmaSmith_CV} target="_blank" rel='noreferrer'><img className="about__cv" src={cv_logo} alt="cv"/></a>
      </div>
    </div>
  )
}
